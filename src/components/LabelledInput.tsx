  ...
  return (
    <div key={props.id} className="mb-4">
      ...
      <div className="flex">
        ...
        />
        <button
          className="ml-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-3 mt-auto mb-auto rounded-lg focus:outline-none focus:shadow-outline-red active:bg-red-500"
