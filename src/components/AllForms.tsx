            ...
            .map((form: Form) => (
              ...
              >
                ...
                <div className="flex col-span-2 justify-center items-center gap-2 flex-wrap">
                  ...
                  <Link
                    ...
                    className={
                      (prop.currentUser
                        ...
                        " bg-amber-400 font-bold  rounded-lg hover:bg-amber-500 px-3 py-1" ||
                      ""
                    }
                  >
                    <svg
                  ...
                  <Link
                    ...
                    className={
                      (prop.currentUser
                        ? ""
                        : "opacity-50 cursor-not-allowed") +
                        " bg-violet-400 font-bold  rounded-lg hover:bg-violet-500 px-3 py-1" ||
                      ""
                    }
                  >
                    <svg
                  ...
                  <button
                    className=" bg-red-500  rounded-lg hover:bg-red-600 hover:text-white p-1 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={!prop.currentUser}
