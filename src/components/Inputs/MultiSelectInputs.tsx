  ...
  return (
    ...
    >
      ...
      <div className="flex mt-3 ml-2 flex-row  justify-around items-center border-2 border-gray-300 rounded-lg p-2">
        <div className="flex flex-col ml-auto  justify-center items-center  gap-1">
          {props.option.map((optionValues, index) => {
            return (
              <div key={index} className="grid grid-cols-5 gap-2 my-1">
                <label className="mr-2 col-span-1 text-center font-bold">
                  Option {index + 1}
                </label>
                <label className="mr-2 col-span-3 text-center my-auto break-all ">
                  {optionValues}
                </label>
                <button
